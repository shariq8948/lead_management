...
class LeadDetailController extends GetxController {
  ...
  RxList customerType =
      ["Type1", "Type2", "Type3", "Type4", "type5", "Type6", "Type7"].obs;
  RxList registrationType =
      ["Type1", "Type2", "Type3", "Type4", "type5", "Type6", "Type7"].obs;
  RxList partyType =
      ["Type1", "Type2", "Type3", "Type4", "type5", "Type6", "Type7"].obs;
  RxList industry =
      ["Type1", "Type2", "Type3", "Type4", "type5", "Type6", "Type7"].obs;
  RxList state =
      ["state1", "state2", "state3", "Type4", "type5", "Type6", "Type7"].obs;
  RxList area =
      ["area1", "area2", "area3", "area4", "area5", "Type6", "Type7"].obs;
  RxList city =
      ["area1", "area2", "area3", "area4", "area5", "Type6", "Type7"].obs;
  ...
  void fetchLead(String Id) async {
