      ...
      child: Column(
        children: [
          Row(
            ...
            children: [
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Sanket', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                  SizedBox(height: 4),
                  Text('Psm Softtech Pvt Ltd', style: TextStyle(color: Colors.grey)),
                ],
              ),
              Spacer(),
              Chip(
                label: Text('Hot', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
          ...
          Row(
            ...
            children: [
              IconButton(icon: Icon(Icons.call, color: Colors.teal), onPressed: () {}),
              IconButton(icon: Icon(Icons.wallet, color: Colors.green), onPressed: () {}),
              IconButton(icon: Icon(Icons.sms, color: Colors.red), onPressed: () {}),
              IconButton(icon: Icon(Icons.email, color: Colors.blue), onPressed: () {}),
              IconButton(icon: Icon(Icons.share, color: Colors.purple), onPressed: () {}),
            ],
          ),
        ],
      ),
        ...
        children: [
          Padding(
            ...
            child: Text(
              title,
              style: TextStyle(
                color: controller.currentTabIndex.value == index ? Colors.white : Colors.grey[400],
                fontWeight: controller.currentTabIndex.value == index ? FontWeight.bold : FontWeight.normal,
              ),
            ),
          ),
          ...
          ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              bool showDateLabel = index == 0 ||
                  controller.activities[index - 1]['date'] !=
                      activity['date'];
      ...
      children: [
        ...
        if(controller.currentTabIndex==1)
          FloatingActionButton(
            ...
            child: Icon(controller.isFabOpen.value ? Icons.close : Icons.add),
          ),
