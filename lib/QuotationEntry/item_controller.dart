...
class ItemController extends GetxController {
  ...
  //   }).toList();
  // }
  RxList<Products> itemsList = <Products>[
...
void searchItems(){
  ...
  Future<void> fetchProducts({bool isInitialFetch = true}) async {
    ...
    final String pageNumber = currentPage.value.toString(); // Current page number
    ...
    try {
      ...
      if (newProducts.isNotEmpty) {
        if (isInitialFetch) {
          ...
          productList.addAll(newProducts); // Add more data for subsequent fetches
        }
